...
выбор всех десяти карт. При перестановке IP вкладка освобождает старые
адреса выбранных карт до назначения новых, чтобы избежать временных дублей.
Карта с адресом вне сети стенда не допускается к перенастройке.
