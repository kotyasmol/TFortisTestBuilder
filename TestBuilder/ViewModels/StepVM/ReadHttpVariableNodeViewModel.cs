...
{
    public partial class ReadHttpVariableNodeViewModel : NodeViewModel
    {
        ...
        [ObservableProperty] private string outputVariableName = "Dut.value";
        ...
        public ReadHttpVariableNodeViewModel()
        {
            Title = "Read HTTP Variable";
        ...
        public override NodeViewModel Clone() => new ReadHttpVariableNodeViewModel
        {
            BaseUrl = BaseUrl,
            Endpoint = Endpoint,
