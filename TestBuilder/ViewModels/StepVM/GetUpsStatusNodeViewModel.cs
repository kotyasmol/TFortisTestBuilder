...
{
    public partial class GetUpsStatusNodeViewModel : NodeViewModel
    {
        [ObservableProperty] private string baseUrl = "http://192.168.0.1";
        [ObservableProperty] private int timeoutMs = 5000;
        [ObservableProperty] private string outputVariableName = "Dut.ups_rez";
        ...
        public GetUpsStatusNodeViewModel()
        {
        ...
        public ITestStep CreateStep(IHttpRequestService httpRequestService, ILogger logger) =>
            new GetUpsStatusStep(httpRequestService, logger, BaseUrl, TimeoutMs, OutputVariableName, FailOnError);

        public override NodeViewModel Clone() => new GetUpsStatusNodeViewModel
        {
            BaseUrl = BaseUrl,
            TimeoutMs = TimeoutMs,
