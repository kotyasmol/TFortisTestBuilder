    ...
    public sealed class GraphCompiler
    {
        ...
        private ITestStep CreateStep(NodeViewModel node)
        {
            return node switch
            {
                ...
                CheckRegisterEqualityNodeViewModel equality => equality.CreateStep(_modbusService, _logger),
                WaitUntilNodeViewModel waitUntil => waitUntil.CreateStep(_modbusService, _logger),
                PollRegisterNodeViewModel pollRegister => pollRegister.CreateStep(_modbusService, _logger),
